package com.shiba.client.gui;

import com.shiba.client.module.Category;
import com.shiba.client.module.Module;
import com.shiba.client.module.ModuleManager;
...
public class ClickGuiScreen extends Screen {
    ...
    private int moduleListHeight() {
        ...
        return Math.max(mods.size(), 1) * MODULE_HEIGHT;
    }
    ...
    private void renderModules(DrawContext ctx, int mouseX, int mouseY) {
        ...
        for (int i = 0; i < mods.size(); i++) {
            Module m = mods.get(i);
            int rowY = listY + i * MODULE_HEIGHT;
